         ...
         <div class="bg-gray-900 overflow-hidden  shadow-sm sm:rounded-lg">
            <div class="flex items-center justify-between">
                <div class="flex flex-col">
                    <h2 class="text-3xl font-semibold text-gray-200">Room and Laboratory</h2>
                    <h4 class="text-gray-400">Manage room and laboratory in the system</h4>
                </div>
            ...
            <div class="p-6 bg-gray-800 border-2 border-gray-700 h-auto mt-10 rounded-lg">
                <h2 class="text-2xl font-semibold text-gray-200 mb-6">Room and Laboratory List</h2>
                <input type="text" id="quickFilterInput" placeholder="Search by ID, name..." class="mb-4 p-2 rounded bg-gray-800 text-gray-300 border border-gray-700 w-3/4">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const rowData = JSON.parse('{!! $roomJson !!}');
        console.log('Equipment Data:', rowData);
        
        const columnDefs = [
            { field: "id", headerName: "Room ID",
            ...
            { field: "assigned_tech", headerName: "Assigned Technician",
                cellClass: 'text-gray-300 font-medium whitespace-nowrap',
                headerClass: 'text-gray-400 uppercase text-xs font-medium bg-gray-800 ',
             },
